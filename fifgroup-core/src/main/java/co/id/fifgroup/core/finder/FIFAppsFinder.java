...
public interface FIFAppsFinder {
	 ...
	 * @return
	 */
	public SupplierOpexInfo getSupplierOpexByOpexCodeAndOpexType(@Param("opexCode")String opexCode, @Param("companyCode")String companyCode);
	 ...
	 * @param companyId
	 */
	public void updateApTrnSpcPrepayment(@Param("invoiceNumber")String invoiceNumber, @Param("branchCodeNew")String branchCodeNew, @Param("companyCodeNew")String companyCodeNew, @Param("companyId")String companyId);
	 ...
	 * @param employeeNumber
	 */
	public void updateIntensifByEmployeeNumber(@Param("processDate")Date processDate, @Param("employeeNumber")String employeeNumber, @Param("instfFlag")String instfFlag);
	
	public BigDecimal getInsentifByEmployeeNumber(@Param("employeeNumber") String employeeNumber);
	
	public List<IuranKoperasi> selectIuranKoperasiByCompanyId(@Param("companyId") Long companyId, @Param("processDate")Date processDate);
	...
	public List<HutangKoperasi> selectPotonganKoperasiByCompanyId(@Param("companyId") Long companyId, @Param("processDate")Date processDate);
	...
	public void updateGlInterfaceAttribute1ByReference4(@Param("attribute1") String attribute1, @Param("reference4") String reference4);
	public double getTaxPercentageByTaxCode(@Param("taxCode") String taxCode);
	public String getTaxRemarksByTaxCode(@Param("taxCode") String taxCode);

	//add by lisa,1-sep-2015,tiket - 14102810453648//
	public List<TabunganKoperasi> selectTabunganKoperasiByCompanyId(@Param("companyId") Long companyId, @Param("processDate")Date processDate);
	...
	public void updateGlInterfaceAttribute1ByReference4AndSegment2(
			@Param("attribute1")String attribute1, 
			@Param("reference4")String reference4, 
			@Param("segment2")String segment2);
	// end added by Jatis, 5 Jan 2016
	
	//add by RIM - 15100808164486 - Inv PPH pesangon tdk terbentuk jika pesangon = 0
	public void updateInvoiceTotalTerminationToBeNol(@Param("invoiceNumber") String invoiceNumber);
	public void updateInvoiceDtlTotalTerminationToBeNol(@Param("invoiceNumber") String invoiceNumber);
	public void updateInvoicePaidFlagWhereIfTotalAmountIsNol(@Param("invoiceNumber") String invoiceNumber);
	public List<InvoiceInterface> getDataTerminationForPesangonMailReminder(@Param("sequenceDay") int sequenceDay);
	public Integer getDataSelisihTerminationForPesangonMailReminder(@Param("sequenceDay") int sequenceDay);
	public List<Long> getPersonIdByInvoiceNumberTermination(@Param("invoiceNumber") String invoiceNumber, @Param("companyId") Long companyId);
	public Double getTakeHomePayByPersonIdAndTrnId(@Param("personId") Long personId, @Param("trnId") Long trnId);
	public void updateEmpPayDtlWhereThpIsNol(@Param("personId") Long personId, @Param("trnId") Long trnId);	
	public void insertEmpPayDtlWhereThpIsNol(@Param("personId") Long personId, @Param("trnId") Long trnId, @Param("companyId") Long companyId, @Param("createdBy") Long createdBy);
	//end add by RIM - 15100808164486 - Inv PPH pesangon tdk terbentuk jika pesangon = 0
	public String checkNullSegment2(@Param("segment2")String segment2);
}
