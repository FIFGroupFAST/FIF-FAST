...
public class AssetRetirementDetailImageComposer extends SelectorComposer<Window> {
	...
	private void init() {
		...
		listDetailImage = retirementService.getDetailImageByPrimaryKey(retirementBast.getId());
