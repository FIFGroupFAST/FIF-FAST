...
public class AssetRetirementPopupComposer extends SelectorComposer<Window> {
	...
	public void searchAsset(){
		...
		pgListOfValue.setTotalSize(retirementService.countAssetSODtlByCriteria(searchCriteria(),action));
	...
	List listData = retirementService.getAssetSODtlByCriteria(searchCriteria(),pgListOfValue.getPageSize(), pgListOfValue.getActivePage() * pgListOfValue.getPageSize(),action);
